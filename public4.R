...
pset1= public[public$EssaySet=="4",]

View(pset1)

pset1$nounCount= rep(0, 295)
pset1$verbCount= rep(0, 295)
pset1$adjectiveCount= rep(0, 295)
pset1$adverbCount= rep(0, 295)
...
write.csv(pset1 , "pset4.csv", row.names = F)
...
pset1= read.csv("pset4.csv")
newset1= read.csv("Set4.csv")
newset1$Score2=NULL
str(newset1)
