...
pset1= public[public$EssaySet=="2",]

View(pset1)

pset1$nounCount= rep(0, 426)
pset1$verbCount= rep(0, 426)
pset1$adjectiveCount= rep(0, 426)
pset1$adverbCount= rep(0, 426)
...
write.csv(pset1 , "pset2.csv", row.names = F)
...
pset1= read.csv("pset1.csv")
newset1= read.csv("Set2.csv")
newset1$Score2=NULL
str(newset1)
