...
pset1= public[public$EssaySet=="9",]
...
write.csv(pset1 , "pset9.csv", row.names = F)
...
pset1=read.csv("pset9.csv")
newset1= read.csv("Set9.csv")
newset1$Score2=NULL
str(newset1)
...
rforest.model <- h2o.randomForest(y=y.dep, x=x.dep, training_frame = train.h2o, ntrees = 500, max_depth = 6)
predict.rforest <- as.data.frame(h2o.predict(rforest.model, test.h2o))

h2o.varimp(rforest.model)[1:20,]
