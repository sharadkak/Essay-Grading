...
pset1= public[public$EssaySet=="3",]

View(pset1)

pset1$nounCount= rep(0, 406)
pset1$verbCount= rep(0, 406)
pset1$adjectiveCount= rep(0, 406)
pset1$adverbCount= rep(0, 406)
...
write.csv(pset1 , "pset3.csv", row.names = F)
...
pset1=read.csv("pset3.csv")
newset1= read.csv("Set3.csv")
newset1$Score2=NULL
str(newset1)
...
#### bigrams didnt give any increase in accuracy for this set so i didnt use them in final model
